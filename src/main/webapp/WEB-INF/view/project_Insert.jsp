						...
						<div class="modal fade" id="exampleModalCenter2">
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										<form>
											<input type="checkbox" class="check" value="디자인1팀"> 디자인1팀 
											<input type="checkbox" class="check" value="디자인2팀"> 디자인2팀 
											<input type="checkbox" class="check" value="개발1팀"> 개발1팀
											<input type="checkbox" class="check" value="개발2팀"> 개발2팀
											<input type="checkbox" class="check" value="기획1팀"> 기획1팀
											<input type="checkbox" class="check" value="기획2팀"> 기획2팀
